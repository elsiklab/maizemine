 ...
 *
 * MaizeMine customization: don't do this if Location.doNotComputeOverlaps flag is set.
 *
 * @author Richard Smith
 * @author
 */
public class MaizeCreateLocationOverlapIndexProcess extends PostProcessor
{

    private static final String RANGE_TYPE = "int4range";
    private static final Logger LOG = Logger.getLogger(MaizeCreateLocationOverlapIndexProcess.class);
     ...
     */
    public MaizeCreateLocationOverlapIndexProcess(ObjectStoreWriter osw) {
        super(osw);
    }
