 ...
 *
 * MaizeMine customization: do not include locations with donotcomputeoverlap flag set.
 *
 * @author Kim Rutherford
 * @author
 */
public class MaizeCreateOverlapViewProcess extends PostProcessor
{

    private static final Logger LOG = Logger.getLogger(MaizeCreateOverlapViewProcess.class);
     ...
     */
    public MaizeCreateOverlapViewProcess(ObjectStoreWriter osw) {
        super(osw);
    }
