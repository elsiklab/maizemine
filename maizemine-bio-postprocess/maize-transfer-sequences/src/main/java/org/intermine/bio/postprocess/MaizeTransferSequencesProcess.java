 ...
 *
 * MaizeMine override: changed main db query, changed how CDS handled
 *
 * @author Kim Rutherford
 * @author
 */
public class MaizeTransferSequencesProcess extends PostProcessor
{
    private Model model;
    private static final Logger LOG = Logger.getLogger(MaizeTransferSequencesProcess.class);
     ...
     */
    public MaizeTransferSequencesProcess(ObjectStoreWriter osw) {
        super(osw);
    }
