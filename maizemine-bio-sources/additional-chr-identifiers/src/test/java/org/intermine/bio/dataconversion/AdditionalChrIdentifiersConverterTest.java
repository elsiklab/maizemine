...
public class AdditionalChrIdentifiersConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    AdditionalChrIdentifiersConverter converter;
    MockItemWriter itemWriter;

    public AdditionalChrIdentifiersConverterTest(String arg) {
        super(arg);
    }
