...
public class AdditionalGeneAttributesConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    AdditionalGeneAttributesConverter converter;
    MockItemWriter itemWriter;

    public AdditionalGeneAttributesConverterTest(String arg) {
        super(arg);
    }
