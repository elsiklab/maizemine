...
public class ExpressionMetadataConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    ExpressionMetadataConverter converter;
    MockItemWriter itemWriter;

    public ExpressionMetadataConverterTest(String arg) {
        super(arg);
    }
