...
public class MaizeEnsemblComparaConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    MaizeEnsemblComparaConverter converter;
    MockItemWriter itemWriter;

    public MaizeEnsemblComparaConverterTest(String arg) {
        super(arg);
    }
