...
public class MaizeExpressionGeneConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    MaizeExpressionGeneConverter converter;
    MockItemWriter itemWriter;

    public MaizeExpressionGeneConverterTest(String arg) {
        super(arg);
    }
