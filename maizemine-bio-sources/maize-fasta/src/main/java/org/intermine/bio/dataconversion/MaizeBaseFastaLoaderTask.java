 ...
 * Maize FASTA loaders depend on.
 * @author
 */
public class MaizeBaseFastaLoaderTask extends FastaLoaderTask
{
    private static final Logger LOG = Logger.getLogger(MaizeBaseFastaLoaderTask.class);
