 ...
 * @author
 */
public class MaizePathwaysConverter extends BioFileConverter
{
    protected static final Logger LOG = Logger.getLogger(MaizePathwaysConverter.class);
    protected static final String MAIZE_TAXON_ID = "4577";
     ...
     */
    public MaizePathwaysConverter(ItemWriter writer, Model model, String dataSourceName, String dataSetTitle) {
    ...
    /**
     * Sets the gene source for genes created during loading
     */ 
    public void setGeneSource(String geneSource) {
        this.geneSource = geneSource;
        LOG.info("Setting gene source to " + this.geneSource);
    }
    ...
    protected Item getGene(String geneCG, String organism, ReferenceList referenceList)
        ...
        if (gene == null) {
            ...
            // Set gene source if applicable
            if (MAIZE_TAXON_ID.equals(taxonId) && (geneSource != null)) {
    ...
    protected Item getPathway(String identifier) {
