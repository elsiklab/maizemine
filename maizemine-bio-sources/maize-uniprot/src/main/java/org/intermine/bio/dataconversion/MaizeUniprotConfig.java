 ...
 *
 */
public class MaizeUniprotConfig
{
    private static final Logger LOG = Logger.getLogger(MaizeUniprotConfig.class);
     ...
     */
    public MaizeUniprotConfig(String propFile) {
        if (propFile != null) {
