 ...
 */
public class MaizeUniprotConverter extends BioDirectoryConverter
{
    private static MaizeUniprotConfig CONFIG = null;
    private static final Logger LOG = Logger.getLogger(MaizeUniprotConverter.class);
     ...
     */
    public MaizeUniprotConverter(ItemWriter writer, Model model) {
     ...
     */
    public void setup() {
        CONFIG = new MaizeUniprotConfig(configFile);
        if (taxonIds != null) {
            addSubspecies();
        }   
    }
