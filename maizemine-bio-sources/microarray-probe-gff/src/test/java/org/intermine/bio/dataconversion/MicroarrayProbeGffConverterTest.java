...
public class MicroarrayProbeGffConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    MicroarrayProbeGffConverter converter;
    MockItemWriter itemWriter;

    public MicroarrayProbeGffConverterTest(String arg) {
        super(arg);
    }
