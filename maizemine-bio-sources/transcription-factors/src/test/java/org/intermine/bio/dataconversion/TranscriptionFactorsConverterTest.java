...
public class TranscriptionFactorsConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    TranscriptionFactorsConverter converter;
    MockItemWriter itemWriter;

    public TranscriptionFactorsConverterTest(String arg) {
        super(arg);
    }
