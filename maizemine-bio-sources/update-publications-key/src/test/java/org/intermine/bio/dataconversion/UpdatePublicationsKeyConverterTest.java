...
public class UpdatePublicationsKeyConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    UpdatePublicationsKeyConverter converter;
    MockItemWriter itemWriter;

    public UpdatePublicationsKeyConverterTest(String arg) {
        super(arg);
    }
