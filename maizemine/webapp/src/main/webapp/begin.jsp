    ...
    <div id="search-bochs">
      ...
      <div class="inner">
        ...
        <form action="<c:url value="/keywordSearchResults.do" />" name="search" method="get">
          <div class="input"><input id="actionsInput" name="searchTerm" class="input" type="text" value="${WEB_PROPERTIES['begin.searchBox.example']}">
          </div>
          <div class="bottom">
            <center><input id="mainSearchButton" name="searchSubmit" class="button dark" type="submit" value="search"/></center>
          </div>
        </form>
        <div style="clear:both;"></div>
      </div><!--end inner div-->
    </div><!--end search-bochs div-->
    <div id="lists-bochs">
      ...
      <div class="inner">
        ...
        <form name="buildBagForm" method="post" action="<c:url value="/buildBag.do" />">
          ...
          <div class="bottom">
            <center>
              <a class="advanced" href="bag.do?subtab=upload">advanced</a><br />
              <input class="button light" type="submit" value="analyze"/>
            </center>
          </div>
        </form>
      </div><!--end inner div-->
    </div><!--end list-bochs div-->
